...
export async function GET(req: NextRequest) {
  try {
    ...
    console.log("External wallet API called with companyId:", companyId, "userId:", userId, "gameName:", gameName);
    ...
    return NextResponse.json({
      ...
      companyId: companyId,
      gameName: gameName,
      message: "External wallet balance retrieved successfully"
    });
  } catch (error) {
    console.error("Error in external wallet API:", error);
    return NextResponse.json(
      { 
        success: false,
